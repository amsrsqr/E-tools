...
const AddEditRepresentativeCategory = ({
  ShowModel,
  Data,
  type,
  ...
  const validateForm = (values) => {
    ...
    if (values.name === "" || values.name.trim() === "") {
      errorObj.name = REPRESENTATIVECATEGORY;
      errorArr.push({ name: REPRESENTATIVECATEGORY });
    }
  ...
  async function saveRepresentativeCategory(
    fields,
    ...
    if (type == EDIT) {
      ...
      representativeCategoryService
        .updateRepresentativeCategory(id, fields.name, ckEditorDescription)
        .then((res) => {
          setLoading(false);
      ...
      setLoading(true);
      representativeCategoryService
        .addRepresentativeCategory(fields.name, ckEditorDescription)
        .then((res) => {
          setLoading(false);
          callBackAddEditFormToViewForm(false, true, res.message);
          setShow(false);
  ...
  return (
    <Formik
      ...
      validateOnBlur={true}
      onSubmit={saveRepresentativeCategory} 
    >
      {({
        errors,
        handleReset,
...
export default AddEditRepresentativeCategory;
