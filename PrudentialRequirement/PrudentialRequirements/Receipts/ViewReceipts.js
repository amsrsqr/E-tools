...
const ViewReceipts = ({ selectedFacility }) => {
  ...
  const getReceipts = () => {
    ...
    prudentialReceiptsService
      .getPrudentialReceipts(selectedFacility.facility_id)
  ...
  const prudentialReceiptsList = React.useMemo(() => receipts);
    ...
    <>
      {loading ? (
        ...
        <Page title="">
          ...
          <ReactTable columns={columns} data={prudentialReceiptsList} />
          {showAddEditForm && (
            <AddReceipts
